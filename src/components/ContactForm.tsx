...
const inputClasses =
  "w-full rounded-xl border border-border bg-background px-4 py-3 text-[15px] text-foreground placeholder:text-muted-soft transition-colors duration-200 focus:border-foreground focus:outline-none";
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-4" noValidate>
      ...
      <button
        ...
        className="inline-flex w-full items-center justify-center gap-2 rounded-full bg-accent px-6 py-3.5 text-[15px] font-medium text-accent-foreground transition-colors duration-200 hover:bg-accent/85 disabled:cursor-not-allowed disabled:opacity-60 sm:w-auto"
      >
        {status === "sending" ? (
          <>
