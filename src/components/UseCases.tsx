    ...
    >
      ...
      <div className="grid gap-6 md:grid-cols-3 md:gap-8">
        {useCases.map((item, i) => (
          <motion.div
            key={item.friction}
            className={`flex flex-col rounded-3xl bg-foreground/[0.02] p-9 sm:p-10 ${styles.glowCard}`}
          ...
          >
            <div className="mb-8 flex h-16 w-16 items-center justify-center rounded-2xl border border-foreground/10">
